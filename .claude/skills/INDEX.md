...
|---|---|
| Create a GitHub Issue | `.agents/skills/start_task/SKILL.md` (then use `gh issue create` directly — no `create_issue.sh` in this repo) |
| Start a new task (branch + draft PR) | `.agents/skills/start_task/SKILL.md` |
| Push, review, or merge a PR | `.agents/skills/github_workflow/SKILL.md` |
| Create or manage wiki pages | `.agents/skills/wiki/SKILL.md` |
| Summarize the session | `.agents/skills/session_summary/SKILL.md` |
| Add a hook | `.agents/skills/add_hook/SKILL.md` |
| Add a slash command | `.agents/skills/add_command/SKILL.md` |
| Live E2E test the scaffolder (build+install wheel, scaffold real projects, use them) | `.agents/skills/live_test/SKILL.md` (user-only: `/live_test`) |
