...
| Human workspace | `.agents/vault/` | Humans | None needed |
...
- `.agents/vault/` is exploratory — humans write here, agents don't read it
...
- Scaffolded projects receive `.agents/docs/` with ADR and development templates
