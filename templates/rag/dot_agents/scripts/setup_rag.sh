...
# the .cocoindex_code/ index lands in the repo (this script lives at .agents/scripts/).
...
SENTINEL="# Written by .agents/scripts/setup_rag.sh"
...
Expose it to agents over MCP (see .agents/rules/rag.md):
