...
Keeps everything agentic-dev-related under a single root folder. Obsidian doesn't care that the path is hidden — point it at `.agents/vault/` and use normally.
